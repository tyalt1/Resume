...
%Contact Information
\centerline{
1 Rockland Terrace - Natick, MA \textbullet \hspace{1pt}
...
GPA: 3.47 \hspace{75pt} Dean's List All Semesters
...
\leftline{\bf Computing 2 Grader}
\begin{itemize}
\itemsep0em
	\item Tutored students in computer science basics and data structures.
\end{itemize}
...
\begin{tabular}{l|l}
	...
	\tabitem \textit{Shell:} Bash, PowerShell & \tabitem \textit{Virtualization:} Oracle VirtualBox, VMWare Workstation \\
